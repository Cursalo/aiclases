...
// Temporarily remove ErrorBoundary import to fix prerendering
...
function CoursesGrid({ searchQuery = '', selectedCategory = '', selectedLevel = '' }) {
  ...
  const loadCourses = async () => {
    try {
      ...
      // Remove random error simulation for build stability
        ...
        <main className="lg:w-3/4">
          <div className="flex items-center justify-between mb-6">
            <div className="text-sm text-muted-foreground">
              <span id="course-count">Mostrando cursos disponibles</span>
            </div>
