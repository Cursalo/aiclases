...
// MVP: Simple select without Radix UI dependencies
  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "absolute z-50 max-h-96 min-w-32 overflow-auto rounded-md border bg-popover p-1 text-popover-foreground shadow-md",
